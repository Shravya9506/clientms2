...
class OwnedCar(models.Model):
    ...
    car_model = models.CharField(max_length=140, blank=True)
    vin = models.CharField(max_length=17, blank=True)
    date_of_purchase = models.DateField(auto_now_add=False, blank=True)
    date_of_last_service = models.DateField(auto_now_add=False, blank=True)
    author = models.ForeignKey(
        get_user_model(),
        on_delete=models.CASCADE,
        blank=True
